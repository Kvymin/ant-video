...
// 小程序 Node worker 的 cwd 属于宿主，业务数据必须显式放在包内目录。
const dataDir = process.env.MIGU_DATA_DIR || process.cwd()

export { userId, token, port, host, rateType, debug, mrefreshToken, pass, enableHDR, programInfoUpdateInterval, enableH265, ignoreCategory, mergeTVCategory, customMergeCategory, dataDir }
